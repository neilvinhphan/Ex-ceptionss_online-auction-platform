...
| **Nguyễn Hoàng Thông** | Database Developer                           | - Lên ý tưởng & thiết lập cấu hình sơ khai bộ khung hệ thống Multi-module<br>- Phân tích & thiết kế lược đồ CSDL (ERD), viết SQL chuẩn hóa<br>- Xây dựng hệ thống DAO để tương tác an toàn với CSDL<br>- Thiết lập JDBC Connection, quản trị & vận hành Database trực tuyến                                                                  |
